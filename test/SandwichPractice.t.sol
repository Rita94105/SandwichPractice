...
contract SandwichPracticeTest is SandwichSetUp {
    ...
    function _attackerAction1() internal {
        ...
        // attacker swap 1 ETH to USDC
        uniswapV2Router.swapExactETHForTokens{ value: 1 ether }(0, path, attacker, block.timestamp);

        console.logString("attacker usdc balance after swap eth: ");
        console.logUint(usdc.balanceOf(attacker));
    ...
    function _attackerAction2() internal {
        ...
        console.logString("attacker eth balance: ");
        console.logUint(attacker.balance);
    ...
    function _checkAttackerProfit() internal {
        ...
        console.logString("attacker profit: ");
